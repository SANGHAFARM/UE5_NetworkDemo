	...
	FString& ErrorMessage)
{
	...
	// ErrorMessage에 아무런 값을 입력하지 않으면, 로그인 통과
	// 하지만 ErrorMessage에 값을 할당하면, 오류로 간주
...
void AABGameMode::DefaultGameTimer()
{
	...
	{
		// DefaultGameTimer 함수는 1초마다 반복되기 때문에 1초씩 감소 처리
